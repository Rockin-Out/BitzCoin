...
const string strMessageMagic = "BitzCoin Signed Message:\n";
...
// Rock n' Rollers coin base reward
...
// Rock n' Rollers coin stake reward based on coin age spent (coin-days)
