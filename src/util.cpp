...
int nAnonymizeBitzCoinAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BitzCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BitzCoin
    // Mac: ~/Library/Application Support/BitzCoin
    // Unix: ~/.BitzCoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitzCoin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "BitzCoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "BitzCoind.pid"));
